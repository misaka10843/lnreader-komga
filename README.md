...
This repository provides an optimized version of the Komga plugin for LNReader, specifically addressing the issue of missing "Volume n" displays. 

**This plugin is for personal use and currently only supports Chinese.**

这个仓库是优化LNReader的Komga插件，特别是对于不支持显示第n卷进行更改
